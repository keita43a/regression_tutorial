...
2. `r_practice`フォルダに`data`フォルダを作成し、武蔵大学経済学部の学生数データを<a href="https://keita43a.github.io/regression_tutorial/data/musashi_keizai_students_2025.csv" download="musashi_keizai_students_2025.csv">こちら</a>からダウンロードして保存するか、以下のコードを実行する。
...
- `Error: path does not exist:’`というエラーが出る場合は、ファイルの相対パスが間違っている可能性がある
  - `r_practice`プロジェクトを開いていることを確認する
  - `getwd()`で自分が`r_practice`フォルダにいることを確認する
  - `musashi_keizai_students_2025.csv`がきちんとdataフォルダに入っていることを確認する
...
人文学部の学生数データ。
人文学部のデータは<a href="https://keita43a.github.io/regression_tutorial/data/musashi_jinbun_students_2025.csv" download="musashi_jinbun_students_2025.csv">こちら</a>からもダウンロードできる。
