...
2. `r_renshu`フォルダに`data`フォルダを作成し、武蔵大学経済学部の学生数データを<a href="https://keita43a.github.io/regression_tutorial/data/musashi_keizai_students_2025.csv" download="musashi_keizai_students_2025.csv">こちら</a>からダウンロードして保存するか、以下のコードを実行する。
